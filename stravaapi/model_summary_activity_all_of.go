...
// checks if the SummaryActivityAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SummaryActivityAllOf{}
...
func (o SummaryActivityAllOf) ToMap() (map[string]interface{}, error) {
